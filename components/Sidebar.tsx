import type { DocumentData } from '@/app/lib/docs';
...
const Sidebar = ({ docs }: SidebarProps) => {
    ...
    const nonRoots: Record<string, DocumentData[] | undefined> = Object.groupBy(
        // docs.filter((doc): doc is DocumentData & {parent: string } => Boolean(doc.parent) ),
